...
import com.example.knightcube.recipeapp.ui.IngredientsActivity;
import com.example.knightcube.recipeapp.ui.StepListActivity;
...
public class RecipeAdapter extends RecyclerView.Adapter<RecipeAdapter.RecipeViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final RecipeViewHolder holder, final int position) {
        Log.i(TAG, "onBindViewHolder: "+recipeList.size());
